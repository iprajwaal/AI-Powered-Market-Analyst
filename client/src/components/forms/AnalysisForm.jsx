...
export default function AnalysisForm() {
  ...
  const validate = () => {
    ...
    if (!formData.company_name && !formData.industry_name) {
      newErrors.company_name = 'Either company name or industry name is required';
      newErrors.industry_name = 'Either company name or industry name is required';
    }
    
    if (formData.num_use_cases && (formData.num_use_cases < 1 || formData.num_use_cases > 10)) {
