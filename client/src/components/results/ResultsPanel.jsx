...
export default function ResultsPanel({ requestId }) {
  ...
  if (loading && (!analysisData || analysisData.status === 'pending' || analysisData.status === 'running')) {
    const statusMessage = analysisData ? 
      analysisData.status === 'pending' ? 'Initializing analysis...' : 'Running analysis...' 
      : 'Loading...';
      ...
      <div className="py-12">
        <Card>
          <div className="flex flex-col items-center py-8">
            ...
            <p className="mt-4 text-sm text-gray-500">This may take a few minutes</p>
          </div>
        </Card>
      </div>
    );
      ...
      <div className="py-12">
        <Card>
          <div className="text-center py-8">
            ...
            <p className="mt-2 text-sm text-gray-500">No analysis data is available</p>
            <div className="mt-6">
              <Button variant="outline" onClick={() => window.location.href = '/'}>
                Start New Analysis
              </Button>
        ...
        <div className="px-4 py-5 sm:p-6">
          {showMarkdown && markdown ? (
            ...
            <div>
                ...
                <div className="mb-6">
                  ...
                  <div className="mt-2 grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-2">
                    <div className="sm:col-span-2">
                      ...
                      <p className="mt-1 text-sm text-gray-900">{analysisData.company_info.description}</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-gray-500">Industry:</span>
                      <p className="mt-1 text-sm text-gray-900">{analysisData.company_info.industry}</p>
                    </div>
                    {analysisData.company_info.products && analysisData.company_info.products.length > 0 && (
                      <div>
                        <span className="text-sm font-medium text-gray-500">Products/Services:</span>
              ...
              {analysisData.industry_info && (
                <div className="mb-6">
                  ...
                  <div className="mt-2 grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-2">
                    <div className="sm:col-span-2">
                      <span className="text-sm font-medium text-gray-500">Description:</span>
                      <p className="mt-1 text-sm text-gray-900">{analysisData.industry_info.description}</p>
                    </div>
                    ...
                    {analysisData.industry_info.challenges && analysisData.industry_info.challenges.length > 0 && (
                      <div>
                        <span className="text-sm font-medium text-gray-500">Challenges:</span>
                        <ul className="mt-1 text-sm text-gray-900 list-disc list-inside">
              ...
              <div className="mt-8">
                <h3 className="text-lg font-medium text-gray-900 mb-4">AI and GenAI Use Cases</h3>
