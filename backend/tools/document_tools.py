...
class DocumentTools:
    ...
    def format_use_cases_markdown(self, 
                                use_cases: List[Dict[str, Any]], 
                                company_info: Dict[str, Any],
                                industry_info: Dict[str, Any],
                                resources: Dict[str, List[Dict[str, Any]]]) -> str:
        ...
        for i, use_case in enumerate(use_cases):
            ...
            if use_case_resources:
                ...
                for resource in use_case_resources:
                    ...
                    resources_text += f"- [{resource_title}]({resource_url}) ({resource_source})\n"
...
"""
    ...
    def save_use_cases_markdown(self, 
                             markdown: str, 
