...
def create_resource_workflow(llm: LLMInterface, dataset_tools: DatasetTools):
    ...
    async def collect_resources(state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for use_case in use_cases:
            ...
            use_case_resources = await dataset_tools.find_datasets_for_use_case(use_case)
    ...
    async def evaluate_resources(state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for use_case in use_cases:
            ...
            resources_text = "\n\n".join([
                ...
                for i, r in enumerate(use_case_resources[:10])  # Limit to 10 resources for evaluation
            ])
            ...
            try:
                ...
                for item in relevance_items:
                    ...
                    if resource_title in title_to_resource:
                        title_to_resource[resource_title]["relevance_score"] = item.get("relevance_score", 5)
                        title_to_resource[resource_title]["relevance_notes"] = item.get("relevance_notes", "")
